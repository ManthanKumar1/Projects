        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            I have developed a strong interest in programming and have learned at least something, I believe. 🤷‍♂️
              ...
              while working with databases such as <b className="purple">MongoDB and MySQL, </b>
              and deploying solutions on <b className="purple">AWS servers.</b>
            </p>
          </Col>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/ManthanKumar1"
                  target="_blank"
                  rel="noreferrer"
